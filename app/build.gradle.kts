...
dependencies {
    ...
    implementation(project(ModulesConfig.userData))
    implementation(project(ModulesConfig.userDomain))
    implementation(project(ModulesConfig.userPresentation))
    implementation(project(ModulesConfig.postData))
    implementation(project(ModulesConfig.postDomain))
    implementation(project(ModulesConfig.postPresentation))
